...
<main class="main">
    <div class="main__contenedor">
        <div class="main__intro">
            ...
            <p class="main__p">Aprovecha este apartado para descargar los informes<br>
                mensuales de las copias completas,<br>usa el buscador para encontrar<br>
        ...
        <div class="main__crear">
            <a href="/completa" class="main__btn main__btn--c">Regresar</a>
        </div>
    </div>
    ...
    <div class="main__filtros">
        <form class="formularioFiltro" method="GET" action="/completa-descargar-mensual">
        ...
        <a href="/completa-descargar-mensual?page=1" class="main__btn main__btn--bf">Borrar Filtro</a>
                        ...
                        <tr class="table__tr">
                            ...
                            <td class="table__td--acciones">
                                <!-- Enlace para redirigir al usuario a la vista de editar-copia, además se manda el id de la copiaEncabezao a editar
                                 por medio de la URL -->
                                <a class="table__accion table__accion--descargarPDF" href="descargar-icm?fecha=<?php echo $copia->fecha; ?>">
                                    <i class="fa-solid fa-file-pdf"></i>
                                    PDF
                                </a>
                                <a class="table__accion table__accion--descargarExcel" href="descargar-iceM?fecha=<?php echo $copia->fecha; ?>">

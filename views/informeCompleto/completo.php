...
<main class="main">
    <div class="main__contenedor">
        <div class="main__intro">
            ...
            <p class="main__p">Aprovecha este apartado para descargar el informe<br>
                completo de todos los tipos de copias,<br>usa el buscador para encontrar<br>
    ...
    <div class="main__filtros">
        <form class="formularioFiltro" method="GET" action="/completo-descargar">
        ...
        <a href="/completo-descargar?page=1" class="main__btn main__btn--bf">Borrar Filtro</a>

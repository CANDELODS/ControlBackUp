...
class CompletaInformesController
{
    ...
    public static function get(Router $router)
    {
        ...
        if (!$pagina_actual || $pagina_actual < 1) {
            header('Location: /completa-descargar-diaria?page=1');
        }
        ...
        if ($fecha) {
            ...
            $total_registros = CopiasEncabezado::totalWhereLike3('fecha', $fecha, 0);
            ...
            if (!$total_registros) {
                ...
                $total_registros = CopiasEncabezado::totalWhere('tipoDeCopia', 0);
                ...
                $copias = CopiasEncabezado::paginarWhere('tipoDeCopia', 0, 'fecha', $registros_por_pagina, $paginacion->offset());
            }
        ...
        $router->render('completa/descargarD', [
            'titulo' => 'Completa - Descargar Diaria',
    ...
    public static function getM(Router $router)
    {
        ...
        if (!$pagina_actual || $pagina_actual < 1) {
            header('Location: /completa-descargar-mensual?page=1');
            exit;
        }
        ...
        $router->render('completa/descargarM', [
            'titulo' => 'Completa - Descargar Mensual',
            'alertas' => Usuario::getAlertas(),
            'copias' => $copias,
            'copiasDetalle' => $copiasDetalle,
   ...
   public static function exportarPDFM()
    {
        ...
        $detalles = CopiasDetalle::allWhereMes($fecha, 0);
...
<ul>
   ...
   public static function exportarExcel()
    ...
    //Exportar Excel de copias mensuales Completas
